...
"}")
        ...
        self.frame_left_menu_container.setMinimumSize(QtCore.QSize(270, 0))
        ...
        self.frame_left_menu.setGeometry(QtCore.QRect(0, 0, 254, 568))
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/меню.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.led_search.setMinimumSize(QtCore.QSize(380, 30))
